...
?>
    ...
    <div id="overviews" class="section wb">
        <div class="container">
            <?php
            $post= new \Admin\Libs\Category();
            foreach($post->find_all() as $c){
                echo "<div class='section-title row text-center'>";
                    echo "<div class='col-md-8 offset-md-2'>";
                        echo "<h3>{$c->getName()}</h3>";
                        echo "<p class='lead'>{$c->getDescription()}</p>";
                    echo "</div>";
                echo "</div><!-- end title -->";
            }
            ?>
        ...
        <?php    
            echo"<div class='container' pt-2>";
                echo"<div class='row'> ";   
                        ...
                        echo"<div class='col-lg-4 col-md-6 col-12 pt-4'>";
                        echo"<div class='blog-item '>";
                            
                            echo "<div class='image-blog'>";
                                echo "<img class='img-fluid' src='admin/images/". $p->getPhoto() . "' alt='post image' />";
                            echo "</div>";
                            
                            echo "<div class='blog-title'>";
                                echo "<h2>{$p->getTitle()}</h2>";
                            echo "</div>";

                            echo "<div class='blog-desc'>";
                                $content=substr($p->getContent(),0);
                                echo "<p>{$content}</p>";
                            echo "</div>";      
