...
?>
    ...
    <div id="contact" class="section wb">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-11 col-md-11 col-sm-11 pl-5 ml-3">
                        ...
                        <form id="contactform" class="" action="contact.php" name="contactform" method="post">
                            <div class="row row-fluid">
                                ...
                                <div class="text-center pd">
                                    <button type="submit" value="create_contact" id="create_contact" name="create_contact" class="btn btn-light btn-radius btn-brd grd1 btn-block">Add Conctact</button>
                                </div>
                            </div>
                        </form>
                    </div>
