...
class Student extends Database
{
    ...
    protected static $db_fields = array("firstname", "lastname", "email", "phone", "department", "photo", "password");
    ...
    public function verifyStudents($email, $password)
    {
