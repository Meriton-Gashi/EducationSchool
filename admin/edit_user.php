    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                if (isset($_POST['update_user']) && isset($_FILES['image'])) {
                    $user->setFirstname($_POST['firstname']);
                    $user->setLastname($_POST['lastname']);
                    $user->setPhone($_POST['phone']);
                    $user->setEmail($_POST['email']);
                    $user->setPassword($_POST['password']);
                    $user->setRoli($_POST['roli']);
                ...
                <div class="col-lg-9">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-2">Edit User</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="small mb-1" for="email">Roli :</label>
                                    <input class="form-control py-4" name="roli" id="roli" type="roli" 
                                    placeholder="Enter email roli" value="<?php if(!empty($user->getRoli())){ echo $user->getRoli();} ?>" />
                                </div>
                                <div class="form-group">
                                    <label class="small mb-1" for="email">Profile Photo :</label>
                                    <?php echo "<img class='photoimg' src='uploads/{$user->getPhoto()}'>"?>
                                </div>
